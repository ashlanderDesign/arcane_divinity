package com.example.arcanedivinity;
...
@Mod(ArcaneDivinity.MODID)
public class ArcaneDivinity
{
    // Define mod id in a common place for everything to reference
    public static final String MODID = "arcanedivinity";
    // Directly reference a slf4j logger
    private static final Logger LOGGER = LogUtils.getLogger();

    public ArcaneDivinity()
    {
    ...
    private void addCreative(CreativeModeTabEvent.BuildContents event)
    {
        ...
        if (event.getTab() == CreativeModeTabs.INGREDIENTS) {
            event.accept(ModItems.ARCANIUM_INGOT);
            event.accept(ModItems.RAW_ARCANIUM_ORE);
        }
    }
